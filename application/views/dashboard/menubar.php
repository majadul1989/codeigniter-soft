...
<div class="sidebar hidden-xs hidden-sm" data-spy="affix" data-offset-top="50">
    <ul class="menu">
        ...
        <li><a class="dropdown" href="javascript:;">User<i class="local fa fa-chevron-circle-down"></i></a>
            <ul class="sub_menu" style="display: <?php echo  ($pageUrl == 'addUser' || $pageUrl == 'lists' ? 'block' : 'none'); ?>;">
                <li><a class="<?php echo  ($pageUrl == 'addUser'? 'active2' : ''); ?>" href="<?php echo base_url('user/addUser'); ?>">Add New</a></li>
                <li><a class="<?php echo  ($pageUrl == 'lists'? 'active2' : ''); ?>" href="<?php echo base_url('user/lists'); ?>">All User</a></li>
            </ul>
        </li>
